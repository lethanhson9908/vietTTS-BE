...
def TTS(request: TTSRequest):
    text = request.text
    replace_words = request.replace_word
    
    for old_word in replace_words:
        text = text.replace(old_word, replace_words[old_word])
    for old_word in my_dict:
        text = text.replace(old_word, my_dict[old_word])
